...
def test_normal_transcript_returns_formatted_segments(mock_api_cls):
...
@patch("src.transcript_ingestion.fetcher.YouTubeTranscriptApi")
def test_filler_words_are_removed(mock_api_cls):
...
@patch("src.transcript_ingestion.fetcher.YouTubeTranscriptApi")
def test_chunks_within_gap_are_merged(mock_api_cls):
...
@patch("src.transcript_ingestion.fetcher.YouTubeTranscriptApi")
def test_no_english_transcript_raises_error(mock_api_cls):
    """NoTranscriptError is raised when the API cannot find an English transcript."""
